...
// Copyright (c) 2019, The LimaCoin Developer
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 3011716; 
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 2; // 10 minutes
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(10000000000000); // 10 billions
...
const char     CRYPTONOTE_NAME[]                             = "LimaCoin";
...
const int      P2P_DEFAULT_PORT                              =  2024;
const int      RPC_DEFAULT_PORT                              =  2025;
...
const char     LATEST_VERSION_URL[]                          = "http://latest.limacoin.org";
const std::string LICENSE_URL                                = "https://github.com/turtlecoin/turtlecoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xb8, 0x12, 0x5a, 0x9, 0xca 0x54 0x58, 0x44, 0x21, 0xa2, 0x98, 0xb4, 0xb7, 0xc3, 0x45, 0xe4  }
};
